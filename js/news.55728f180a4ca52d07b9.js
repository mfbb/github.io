...
(0, _jquery2.default)(document).ready(function () {
    ...
    (0, _jquery2.default)('.moment').find('.play').on('click', function () {
        ...
        var html = '<div style="height: 30px;width: 200px;text-align: center;">无视频地址</div>';
        if (url) {
            html = '<video id="my-player" class="video-js" src=' + url + ' controls autoplay>您的浏览器不支持 video 标签。</video>';
        }
        $modal_rule_win.find('.rule_title').text(title);
        $modal_rule_win.find('.rule_content').html(html);
    ...
    (0, _jquery2.default)(window).scroll(function () {
        ...
        if ((0, _jquery2.default)(document).height() - ((0, _jquery2.default)(window).scrollTop() + (0, _jquery2.default)('html,body').height()) <= 260) {
            var height = (0, _jquery2.default)(document).height() - ((0, _jquery2.default)(window).scrollTop() + (0, _jquery2.default)('body').height());
            (0, _jquery2.default)('.goToTop').css('margin-bottom', 260 - height + 'px');
        } else {
            (0, _jquery2.default)('.goToTop').css('margin-bottom', '0px');
        }
    });
...
/***/ })
/******/ ]);
//# sourceMappingURL=news.55728f180a4ca52d07b9.js.map